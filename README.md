...
I'm a first-year CS student with a growing interest in **cybersecurity** — understanding how systems can be broken and how to defend them. I enjoy writing clean, logical code and am building a strong foundation in programming to support my security goals.
...
- Foundations of **network security** and **ethical hacking**
- **CTF (Capture the Flag)** challenges to sharpen problem-solving
- How programming languages interact with lower-level systems

---

## 📺 Content

You can follow me on YouTube — come check it out:
**[@owaixyt](https://youtube.com/@owaixyt?si=UW7ZEgqqTT1Z7UiZ)**
